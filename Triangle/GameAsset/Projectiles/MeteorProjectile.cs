...
{
    internal struct MeteorProjectile : Projectile
    {
        ...
        float Projectile.IFrameDuration => -1;
        ...
        public bool Move(ChunkManager seedMapper)
        {
            ...
            _velocity.Y += gravity;
            _position += _velocity;
            _model.Color = Color.Lerp(_model.Color, Color.DarkRed, 0.03f);
        ...
        public Particle[] GetPixelDeathParticles(Random rnd, ObjectManager objectManager)
        {
